...
冒頭で紹介した記事にも同じことが書いてありましたが、OSS のコードはその気になれば普通に読めます。ある程度時間はかかりますが地道にデバッグしまくっていればバグの原因はいつか分かると思います。

- ↑ は頑張ればできるので、まずとっかかりやすいバグや issue をみつけるところが大事
  - 自分が普段使っている OSS であること
  - 普段使っていてバグを引いたとか不便だとか思ったところ → ある程度仕様を把握しているからコードも頭に入って着やすい
  - 治せるレベルのバグであること
